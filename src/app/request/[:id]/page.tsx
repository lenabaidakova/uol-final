            ...
            <Box maxWidth="800px" m="auto" px="4">
                <div className="max-w-4xl mx-auto p-6">
                    <Card className="mb-6">
                        ...
                        <CardContent>
                            <p>
                                The shelter urgently needs cleaning supplies to maintain hygiene standards. Specific
                                items required include
                                mops, disinfectants, and trash bags. Donations can be dropped off at the shelter by this
                                weekend.
                            </p>
                        </CardContent>
                    </Card>
